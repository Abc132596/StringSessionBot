...
DATABASE_URL = os.getenv("DATABASE_URL", "mongodb+srv://abc132596:Mayur.mk.oo7@cluster0.nmhtowy.mongodb.net/?retryWrites=true&w=majority&appName=AtlasApp").strip() # Not a necessary variable anymore but you can add to get stats
